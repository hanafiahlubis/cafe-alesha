...
export default function SignIn() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    toast.success("Login simulasi berhasil! Database .env siap dihubungkan.");
  };
      ...
      <div className="mx-auto max-w-md px-4 sm:px-6">
        <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-xl dark:border-slate-800 dark:bg-slate-900">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-extrabold text-slate-900 dark:text-white">Masuk ke Akun</h1>
            <p className="text-xs text-slate-500 mt-2">Gunakan kredensial Anda untuk melanjutkan</p>
          </div>
